...
public class CreditsAdopter extends RecyclerView.Adapter<CreditsAdopter.CreditsViewHolder>
{
    List<Cast> castList;
    LayoutInflater layoutInflater;

    public CreditsAdopter(List<Cast> castList)
    {
    ...
    public CreditsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new CreditsViewHolder(castItemBinding);
    }

    @Override
    public void onBindViewHolder(@NonNull CreditsViewHolder holder, @SuppressLint("RecyclerView") int position)
    {
        ...
        holder.castItemBinding.castImage.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                Navigation.findNavController(view).navigate(R.id.action_detailFragment_to_castInformationFragment,bundle);
            }
        });
    }
    ...
    public class CreditsViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public CreditsViewHolder(@NonNull CastItemBinding castItemBinding)
        {
